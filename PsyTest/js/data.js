...
const qnaList = [
  {
    ...
    a: [
      { answer: 'a. 청녹 바다가 있는 제주도', type: [5] },
      { answer: 'b. 맛있는 음식이 많은 일본', type: [4] },
      { answer: 'c. 넓은 땅, 많은 기회 미국', type: [1] },
      { answer: 'd. 감성과 예술의 나라 프랑스', type: [0] }
    ]
  }
]
...
const infoList = [
  {
    name: '다양한 과일 주스향 맛이 나는 칵테일! <섹스 온 더 비0>',
